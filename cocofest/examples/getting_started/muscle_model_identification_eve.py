...
n_stim = 50
final_time = 5
model = ModelMaker.create_model("ding2007", is_approximated=False)  # Can not approximate this model in ivp
...
# TODO: change for pulse durations
...
# Charbie: données extraites ici de Vicon (Force, durée de pulse, instants de stim)
#
# # Plotting the identification result
# plt.title("Force state result")
# plt.plot(pickle_time_data, pickle_muscle_data, color="blue", label="simulated")
